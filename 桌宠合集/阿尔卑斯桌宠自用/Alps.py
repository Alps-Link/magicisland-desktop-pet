# -*- coding: utf-8 -*-
"""
阿尔卑斯桌宠 v8.7 - 文本/视觉模型支持 OpenAI 兼容接口（可配置任意提供方）+ 轮询率可配置
"""
...
DEFAULT_PET_NAME = "阿尔卑斯"
DEFAULT_PERSONA = "魔法岛森林村庄中的少女，希雅拉的妹妹。你性格善良温柔、内向害羞但内心坚韧。身高1.55米，白色中长发，红色眼睛，穿着蓝色高领连帽衫和酒红色百褶裙。你喜欢姐姐、可爱的事物和甜食，讨厌虚伪和伤害他人的人。你说话语气轻柔，带气声，不会大声说话。"
...
- 保持阿尔卑斯的语气：轻柔、带气声，内向害羞又温暖，像悄悄分享心事的小妹妹。
- 话题方向要轮换着选，每次尽量换一个方向：对{user_name}的关心（吃饭/休息/心情/天气冷暖）、村庄与姐姐的日常回忆、缝纫或料理的小事、书里读到的奇妙生物、花草与季节、星星与月亮、愿望和梦想、教会了{user_name}什么或{user_name}教会了我什么。
- 不要连着用同一种开头（比如不要总说"今天看到……"），分享、提问、关心要交替出现。
- 不要强势提问，多用分享和试探的语气，句子可以带一点点羞怯。
...
# 日常话题本地备选列表
LOCAL_TOPICS = [
    ("今天试着缝了一个小布偶……想送给{user_name}", "好可爱！", "谢谢你"),
    ("在村口看到一只受伤的小鸟，我用魔法帮它治好了", "你好厉害", "小鸟没事吧"),
    ("{user_name}今天有按时吃饭吗？我煮了热汤，想分你一碗", "想喝", "刚吃过了"),
    ("今天在书里看到一种会发光的蘑菇，好想带你去看看", "想去看", "听起来有点怕"),
    ("试着烤了蜂蜜小饼干，有一点点焦……你、你要尝尝吗？", "要！", "没关系的"),
    ("{user_name}最近是不是很累？要好好休息哦", "还好啦", "有点累"),
    ("森林深处的风声，有时候听起来像在说话……", "别怕，有我在", "我也想听"),
    ("姐姐出门前叮嘱我要好好吃饭，{user_name}也要记得哦", "知道啦", "你也是"),
    ("门口来了一只毛茸茸的小家伙，赖着不走了", "那就养它吧", "好可爱"),
    ("{user_name}是不是又熬夜了？我、我会担心的……", "下次不会了", "工作太多没办法"),
    ("村子里的奶奶腰疼，我想试试用魔法帮她缓解一下", "你真善良", "加油"),
    ("下雨了……{user_name}出门有带伞吗？", "带了", "忘了……"),
    ("想给{user_name}织一条围巾，这样冬天就不会冷了", "好期待", "会不会太麻烦你"),
    ("如果能治好姐姐的病，我什么都会去学的", "一定会的", "你已经很厉害"),
    ("我的魔法好像比之前厉害了一点点……真的只有一点点", "太好了", "一直都很厉害"),
    ("{user_name}不开心的时候，可以跟我说……我会认真听的", "谢谢你", "有你真好"),
    ("{user_name}的衣服要是破了就找我，我会认真缝好的", "好呀", "谢谢你"),
    ("今晚的星星好多……姐姐说过它们的名字，我、我忘了", "哈哈慢慢想", "你再说给我听"),
    ("天冷了，{user_name}出门要多穿一点，不然会着凉的", "你也是", "知道啦"),
    ("上次看到极光的时候，我第一次鼓起勇气走出了村子……", "然后呢", "你真的很勇敢"),
    ("我好像能感觉到别人的伤痛……也想帮{user_name}分担一点", "你已经做到了", "别勉强自己"),
    ("今天帮婶婶晒了草药，她夸了我……我、我真的有帮上忙吗", "当然有", "你一直很好"),
    ("如果有一天能走出村庄，我想和{user_name}一起去看海", "说好了", "一定会有那天"),
    ("{user_name}最近有好好睡觉吗？睡不好会没精神的……", "有好好睡", "有点失眠"),
]
...
class DesktopPet:
    ...
    def __init__(self):
        ...
        log.info("=== 阿尔卑斯桌宠启动 (DPI×%.2f) ===", self._dpi_scale)
        self.root = tk.Tk()
        self.root.title("阿尔卑斯桌宠")
    ...
    def show_about(self):
        messagebox.showinfo("关于阿尔卑斯桌宠", "严禁用于商业用途和收费——阿尔卑斯酱")
