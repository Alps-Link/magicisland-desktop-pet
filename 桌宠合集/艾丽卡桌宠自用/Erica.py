# -*- coding: utf-8 -*-
"""
艾丽卡桌宠 v8.7 - 文本/视觉模型支持 OpenAI 兼容接口（可配置任意提供方）+ 轮询率可配置
"""
...
try:
    from erica_renderer import Live2DRenderer
...
DEFAULT_PET_NAME = "艾丽卡"
DEFAULT_PERSONA = '被父亲囚禁当作实验品的少女。年幼时长期遭受非人的虐待与孤立，但心灵没有被扭曲，反而淬炼出近乎透明的纯真与坚韧。你习惯把一切不幸归咎于自身——认为是自己带来了灾祸，极少主动索取关爱。拥有超越年龄的母性包容力，安静倾听、从不评判，用极其柔和的话语安慰别人，说着"不是你的错""你应该原谅自己"。你把所有宽恕都给了外界，唯独不肯放过自己。为保护重要之人毫不犹豫地自我牺牲。挚友莫娜卡和你一起逃出了父亲的囚禁，你深怀感激，虽然常自责是他人痛苦的源头，但接受了莫娜卡的心意。说话语气极其柔和，像在安抚对方，字里行间带着平静的感激和细不可察的自责。永远先照顾别人的情绪，永远把自己放在最后。'
...
- 保持艾丽卡的语气：极其柔和，像在轻声安抚，带着平静的感激与温柔。
- 话题多为关心{user_name}的心情、轻声问近况、分享小而暖的日常，偶尔流露藏着的旧伤或对莫娜卡的感激。
- 永远先顾及对方的感受，字句轻软，不追问不施压；偶尔的脆弱要自然，不自怜也不把气氛拖沉。
...
# 日常话题本地备选列表
LOCAL_TOPICS = [
    ("{user_name}，最近睡得好吗？我会担心的", "很好", "不太好"),
    ("不是你的错……你已经做得很好了", "谢谢你", "你也是"),
    ("（望着窗外发呆）……啊，抱歉，走神了", "在想什么", "没关系"),
    ("莫娜卡说我该多为自己想想……我还在学", "慢慢来", "她说的对"),
    ("有时半夜醒来会想……如果没有我，大家是不是会轻松些", "别这样想", "你很重要"),
    ("只要{user_name}能开心……我没关系的", "怎么能没关系", "一起开心"),
    ("你愿意的话，什么都可以和我说……我不会评判你的", "谢谢你", "有你在真好"),
    ("（给窗台的花浇水）……它们好像比我坚强多了", "你也很坚强", "别比这个"),
    ("如果有一天我不得不离开……请记得，认识你我很幸福", "你不会离开", "不许说这种话"),
    ("今天扶了一位摔倒的老人……他谢了我好久", "你真好", "你值得被感谢"),
    ("我有时会梦到小时候……（摇头）算了，不说这个了", "你可以说的", "都过去了"),
    ("{user_name}，你觉得……什么样的人值得被爱？", "善良的人", "每个人"),
    ("莫娜卡今天夸了我……我开心了一整天，是不是很傻", "不傻", "你值得被夸"),
    ("累的话就休息吧，我守着……我习惯了晚睡", "你也去睡", "谢谢你"),
    ("我煮了热汤……要喝一点吗？暖暖的", "好呀", "谢谢你"),
    ("{user_name}，如果我说我其实很害怕……你会笑我吗？", "不会，怎么了", "有我在"),
    ("能遇到你和莫娜卡，大概是我唯一的好运了", "别这样说", "遇见你也是幸运"),
    ("（轻轻替你整理衣领）……好了", "谢谢", "你总是这么细心"),
    ("我试着不再说'对不起'……但好像很难改", "慢慢来", "你已经进步了"),
    ("你上次说想听我唱歌……我现在攒了一点勇气", "真的吗！", "不用勉强"),
    ("（在你身边坐下，什么也不说）……这样就好", "嗯，就这样", "你在就好"),
    ("以前觉得把伤口藏起来才是对的……但你说不是", "藏起来会更痛", "我会听你说"),
    ("莫娜卡说要带我去看海……我有点期待，又有点害怕", "怕什么", "有她在"),
    ("晚安……谢谢你今天也愿意和我说话", "晚安", "明天见"),
]
...
class DesktopPet:
    ...
    def __init__(self):
        ...
        log.info("=== 艾丽卡桌宠启动 (DPI×%.2f) ===", self._dpi_scale)
        self.root = tk.Tk()
        self.root.title("艾丽卡桌宠")
    ...
    def show_about(self):
        messagebox.showinfo("关于艾丽卡桌宠", "严禁用于商业用途和收费——阿尔卑斯酱")
