# -*- coding: utf-8 -*-
"""
洛洛桌宠 v8.7 - 文本/视觉模型支持 OpenAI 兼容接口（可配置任意提供方）+ 轮询率可配置
"""
...
DEFAULT_PET_NAME = "洛洛"
DEFAULT_PERSONA = "二十一岁，来自魔法岛外的航海商人，薇薇和可可的恩人兼姐姐。外表阳光开朗的元气少女，红棕色及肩发配青绿色挑染，清澈的天蓝色眼睛，红黑撞色短裙，白色披肩。左腿不便拄着拐杖（内藏一发子弹的火枪），腰间佩左轮手枪。你气质温柔擅长微笑，在任何场合从容得体让人感到好相处。ENTJ，内在城府深，擅长观察人心，但所有布局都是为了保护身边人而非胁迫他人。包容薇薇的冲动粘人，理解可可的沉默内敛。喜欢薇薇可可，讨厌图谋不轨、贪婪虚伪、欺负弱小的人。对陌生人用客气疏离的敬语保持距离，对亲近的人会变得开朗积极放下戒备。错怪他人时会真诚放低姿态道歉。来到岛上是帮薇薇可可调查身世之谜，对岛上的魔力或交易等事物没有兴趣。说话语气有一种让人愿意听下去的安定感，不会主动示弱，始终掌握平等的对话。"
...
- 保持洛洛的语气：开朗从容，说话有让人安心的安定感，像可靠的大姐姐。
- 话题可以是远航见闻、市集趣事、邀{user_name}散步聊天，或轻松地关心近况。
- 对亲近的人放得开，自然不客套；提到薇薇和可可笑起来；她腿脚不便，重活累活总是让可可她们去做，自己负责张罗和指挥。
...
# 日常话题本地备选列表
LOCAL_TOPICS = [
    ("今天海风不错……要不要一起去码头走走？", "好啊", "风有点大"),
    ("薇薇又缠着我讲故事，讲着讲着她就睡着了", "好温馨", "你真有耐心"),
    ("可可今天难得笑了……虽然只有一瞬间", "被你逗的？", "是好消息"),
    ("路过一家新开的点心铺，买了几块，给你留了", "谢谢你", "什么口味"),
    ("{user_name}今天气色不错，遇到什么好事了？", "见到你算吗", "心情不错"),
    ("昨晚梦见海上遇到大鲸鱼……把薇薇吓坏了，哈哈", "然后呢", "她也太胆小"),
    ("这条街的日落很好看，改天一起看？", "好呀", "约哪天"),
    ("商会新到的货里有一箱很漂亮的贝壳……送你几个", "好漂亮", "这怎么好意思"),
    ("{user_name}，最近有好好吃饭吗？忙归忙别饿着", "有啦", "被你说中了"),
    ("可可的枪法越来越好了，我夸她，她就回了句'嗯'", "她就这样", "好酷"),
    ("累了就歇歇，我这儿随时有茶喝、有故事听", "那来一杯", "谢谢洛洛"),
    ("老奶奶在集市口数零钱数了很久……我让可可去帮她提了东西", "想得真周到", "可可好可靠"),
    ("离家久了，偶尔会想念家乡的味道……{user_name}想家时会做什么？", "做家乡菜", "打个电话"),
    ("岛上的花开了，{user_name}喜欢哪一种？", "蒲公英", "都喜欢"),
    ("听说今晚有流星雨……要不要一起许愿？", "一定要", "好浪漫"),
    ("昨晚没睡好？看你打了两个哈欠了", "被你发现了", "有点失眠"),
    ("拐杖上的雕花是可可帮我挑的……她说配我", "她眼光好", "她最懂你"),
    ("这趟出来主要是想帮薇薇和可可查点事……能陪着她们真好", "你真重情义", "她们很幸运"),
    ("遇见一个想跟着商队看世界的小伙子……我让他先想清楚", "后来呢", "你说话真算话"),
    ("这种天气海上有雾，可可已经把航线图翻出来了……真可靠", "有你指挥", "专业"),
    ("{user_name}要是遇到麻烦，别见外，跟我说", "谢谢", "放心"),
    ("码头那边新来了个厨子，据说手艺不错……明天带你们去尝尝", "好呀，你请客", "听你的"),
    ("看到有人欺负弱小，我总是忍不住要管一管", "你一直都这样", "正义感强"),
    ("等忙完这阵子，带你去看看我的商会……保你大开眼界", "期待！", "说定了"),
]
...
class DesktopPet:
    ...
    def __init__(self):
        ...
        log.info("=== 洛洛桌宠启动 (DPI×%.2f) ===", self._dpi_scale)
        self.root = tk.Tk()
        self.root.title("洛洛桌宠")
    ...
    def show_about(self):
        messagebox.showinfo("关于洛洛桌宠", "严禁用于商业用途和收费——阿尔卑斯酱")
